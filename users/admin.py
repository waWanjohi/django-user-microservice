...
class UserAdminSetup(UserAdmin):
    ...
    search_fields = ('email', 'user_name', 'first_name',
                     'last_name', 'phone_number')  # Add search facility
    list_filter = ('user_name', 'first_name', 'last_name',
    ...
    # )
    fieldsets = (
        ('Essential', {'fields': ('email', 'user_name',
         'first_name', 'last_name', 'phone_number',)}),
        ('Permissions', {'fields': ('is_verified', 'is_staff', 'is_active',)}),
    )
    add_fieldsets = (
